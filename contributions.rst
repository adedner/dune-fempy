...
have used this package for, by adding sections to the :ref:`userproejects` chapter.
...
:download:`conversion script<nbscript2rst.sh>`. It takes a python script
...
files *projectname_nb.ipynb* and *projectname.rst*. Send us these three
files in addition to the description file and that's it.

Your python script file *myproject.py* can contain both *markdown* parts for
additional descriptions and python code blocks similar to a jupyter notebook
