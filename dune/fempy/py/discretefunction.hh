...
namespace Dune
{
  ...
  namespace FemPy
  {
    ...
    namespace detail
    {
      ...
      template< class DF >
      inline std::enable_if_t< std::is_same< decltype( std::declval< const Dune::Fem::DefaultLocalRestrictProlong< typename DF::DiscreteFunctionSpaceType > & >().needCommunication() ), bool >::value >
      ...
      template< class DF >
      inline void
      registerRestrictProlong ( pybind11::module module, PriorityTag< 0 > )
      {}

      template< class DF >
      inline void registerRestrictProlong ( pybind11::module module )
      {
      ...
      inline void
      registerDiscreteFunctionConstructor ( pybind11::class_< Dune::Fem::VectorDiscreteFunction< Space, Dune::FemPy::NumPyVector< Field > >, options... > cls, PriorityTag< 2 > )
      {
      ...
      inline std::enable_if_t< std::is_constructible< DF, const std::string &, const typename DF::DiscreteFunctionSpaceType & >::value >
      registerDiscreteFunctionConstructor ( pybind11::class_< DF, options... > &cls, PriorityTag< 1 > )
      {
        using pybind11::operator""_a;
      ...
      template< class DF, class... options >
      inline void
      registerDiscreteFunctionConstructor ( pybind11::class_< DF, options... > &cls, PriorityTag< 0 > )
      {}

      template< class DF, class... options >
      inline void registerDiscreteFunctionConstructor ( pybind11::class_< DF, options... > &cls )
      {
      ...
      inline std::enable_if_t< std::is_convertible< decltype( std::declval< DofVector >().array().data()[ 0 ] ), typename DofVector::FieldType >::value >
      registerDofVectorBuffer( pybind11::class_< DofVector, options... > cls, PriorityTag< 1 > )
      {
      ...
      template< class DofVector, class... options >
      inline void registerDofVectorBuffer ( pybind11::class_< DofVector, options... > cls, PriorityTag< 0 > )
      {}

      template< class DofVector, class... options >
      inline void registerDofVectorBuffer ( pybind11::class_< DofVector, options... > cls )
      {
      ...
      template< class DF, class... options >
      inline void registerDiscreteFunction ( pybind11::module module, pybind11::class_< DF, options... > cls )
      {
