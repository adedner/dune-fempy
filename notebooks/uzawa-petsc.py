...
spcU = create.space("lagrange", grid, dimrange=grid.dimension, order=order, storage="petsc")
spcP = create.space("lagrange", grid, dimrange=1, order=order-1, storage="petsc")
...
solver = {"krylovmethod":"cg","verbose":1}
