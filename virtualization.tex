...
\pyth{interplate} returns an object which still contains the full type
...
any \dune object can now be passed back to The \pyth{solve} method on the scheme is 
...
if there type does not match the exact type of the arguments of that
function.
...
required; in this case any grid function is valid argument.
...
fixing all its argument. Since often a optimized version of such a method
